...
public:
   ...
   * @return 
   */
  ActionConfigDialog(const QHash<QString, ToolbarEntry*> &toolbarList, KDevelop::IPlugin* parent, bool modal = true, Qt::WFlags fl = 0 , const QString& defaultAction = QString::null);
  ~ActionConfigDialog();
  /**
