<!DOCTYPE tags>
<tags>
	<tag name="pfpro_cleanup" type="function" returnType="void" comment="PHP 4 &gt;= 4.0.2, PHP 5">
	</tag>
	<tag name="pfpro_init" type="function" returnType="void" comment="PHP 4 &gt;= 4.0.2, PHP 5">
	</tag>
	<tag name="pfpro_process_raw" type="function" returnType="string" comment="PHP 4 &gt;= 4.0.2, PHP 5">
	...
	<tag name="pfpro_process" type="function" returnType="array" comment="PHP 4 &gt;= 4.0.2, PHP 5">
	...
	<tag name="pfpro_version" type="function" returnType="string" comment="PHP 4 &gt;= 4.0.2, PHP 5">
	</tag>
</tags>