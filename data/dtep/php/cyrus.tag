<!DOCTYPE tags>
<tags>
	<tag name="cyrus_authenticate" type="function" returnType="bool" comment="PHP 4 &gt;= 4.1.0">
	...
	<tag name="cyrus_bind" type="function" returnType="bool" comment="PHP 4 &gt;= 4.1.0">
		<attr name="connection" type="resource" status="required"></attr>
		<attr name="callbacks" type="array" status="required"></attr>
	</tag>
	<tag name="cyrus_close" type="function" returnType="bool" comment="PHP 4 &gt;= 4.1.0">
		<attr name="connection" type="resource" status="required"></attr>
	</tag>
	<tag name="cyrus_connect" type="function" returnType="resource" comment="PHP 4 &gt;= 4.1.0">
	...
	<tag name="cyrus_query" type="function" returnType="bool" comment="PHP 4 &gt;= 4.1.0">
		<attr name="connection" type="resource" status="required"></attr>
		<attr name="query" type="string" status="required"></attr>
	</tag>
	<tag name="cyrus_unbind" type="function" returnType="bool" comment="PHP 4 &gt;= 4.1.0">
		<attr name="connection" type="resource" status="required"></attr>
