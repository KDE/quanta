<!DOCTYPE tags>
<tags>
	<tag name="vpopmail_add_alias_domain_ex" type="function" returnType="bool">
		<attr name="olddomain" type="string"></attr>
		<attr name="newdomain" type="string"></attr>
	</tag>
	<tag name="vpopmail_add_alias_domain" type="function" returnType="bool">
		<attr name="domain" type="string"></attr>
		<attr name="aliasdomain" type="string"></attr>
	</tag>
	...
	<tag name="vpopmail_alias_add" type="function" returnType="bool">
		<attr name="user" type="string"></attr>
		<attr name="domain" type="string"></attr>
		<attr name="alias" type="string"></attr>
	</tag>
	...
	<tag name="vpopmail_set_user_quota" type="function" returnType="bool">
		<attr name="user" type="string"></attr>
		<attr name="domain" type="string"></attr>
		<attr name="quota" type="string"></attr>
	</tag>
</tags>