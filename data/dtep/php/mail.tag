<!DOCTYPE tags>
<tags>
	<tag name="ezmlm_hash" type="function" returnType="int" langVersion="PHP 3&gt;= 3.0.17, PHP 4 &gt;= 4.0.2, PHP 5">
		<attr name="addr" type="string" status="required"></attr>
	</tag>
	<tag name="mail" type="function" returnType="bool" langVersion="PHP 3, PHP 4 , PHP 5">
