<!DOCTYPE tags>
<tags>
	<tag name="SoapClient::SoapClient" type="function" returnType="object" langVersion="">
		<attr name="wsdl" type="mixed" status="required"></attr>
		<attr name="options" type="array" status="optional"></attr>
	</tag>
	<tag name="SoapClient::__call" type="function" returnType="mixed" langVersion="">
	...
	<tag name="SoapClient::__getFunctions" type="function" returnType="array" langVersion="">
	</tag>
	<tag name="SoapClient::__getLastRequest" type="function" returnType="string" langVersion="">
	</tag>
	<tag name="SoapClient::__getLastResponse" type="function" returnType="object" langVersion="">
	</tag>
	<tag name="SoapClient::__getTypes" type="function" returnType="array" langVersion="">
	</tag>
	<tag name="SoapFault::SoapFault" type="function" returnType="object" langVersion="">
	...
	<tag name="SoapHeader::SoapHeader" type="function" returnType="object" langVersion="">
	...
	<tag name="SoapParam::SoapParam" type="function" returnType="object" langVersion="">
		<attr name="data" type="mixed" status="required"></attr>
		<attr name="name" type="string" status="required"></attr>
	</tag>
	<tag name="SoapServer::SoapServer" type="function" returnType="object" langVersion="">
		<attr name="wsdl" type="mixed" status="required"></attr>
		<attr name="options" type="array" status="optional"></attr>
	</tag>
	<tag name="SoapServer::addFunction" type="function" returnType="void" langVersion="">
		<attr name="functions" type="mixed" status="required"></attr>
	</tag>
	<tag name="SoapServer::getFunctions" type="function" returnType="array" langVersion="">
	</tag>
	<tag name="SoapServer::handle" type="function" returnType="void" langVersion="">
		<attr name="soap_request" type="string" status="optional"></attr>
	</tag>
	<tag name="SoapServer::setClass" type="function" returnType="void" langVersion="">
		<attr name="class_name" type="string" status="required"></attr>
		<attr name="args" type="mixed" status="optional"></attr>
	</tag>
	<tag name="SoapServer::setPersistence" type="function" returnType="void" langVersion="">
		<attr name="mode" type="int" status="required"></attr>
	</tag>
	<tag name="SoapVar::SoapVar" type="function" returnType="object" langVersion="">
		<attr name="data" type="mixed" status="required"></attr>
	...
	<tag name="is_soap_fault" type="function" returnType="bool" langVersion="PHP 5">
