<!DOCTYPE tags>
<tags>
	<tag name="cal_days_in_month" type="function" returnType="int">
		<attr name="calendar" type="int"></attr>
		<attr name="month" type="int"></attr>
		<attr name="year" type="int"></attr>
	</tag>
	<tag name="cal_from_jd" type="function" returnType="array">
		<attr name="jd" type="int"></attr>
		<attr name="calendar" type="int"></attr>
	</tag>
	...
	<tag name="jddayofweek" type="function" returnType="mixed">
		<attr name="julianday" type="int"></attr>
	...
	<tag name="jdtofrench" type="function" returnType="string">
		<attr name="juliandaycount" type="int"></attr>
	</tag>
