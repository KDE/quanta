<!DOCTYPE tags>
<tags>
	<tag name="notes_body" type="function" returnType="array">
	...
	<tag name="notes_copy_db" type="function" returnType="string">
		<attr name="from_database_name" type="string"></attr>
		<attr name="to_database_name" type="string"></attr>
	</tag>
	...
	<tag name="notes_create_note" type="function" returnType="string">
		<attr name="database_name" type="string"></attr>
		<attr name="form_name" type="string"></attr>
	</tag>
	...
	<tag name="notes_mark_read" type="function" returnType="string">
		...
		<attr name="note_id" type="string"></attr>
	</tag>
