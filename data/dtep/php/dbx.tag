<!DOCTYPE tags>
<tags>
	<tag name="dbx_close" type="function" returnType="bool" comment="PHP 4 &gt;= 4.0.6, PHP 5">
		<attr name="link_identifier" type="object" status="required"></attr>
	</tag>
	<tag name="dbx_compare" type="function" returnType="int" comment="PHP 4 &gt;= 4.1.0, PHP 5">
	...
	<tag name="dbx_connect" type="function" returnType="object" comment="PHP 4 &gt;= 4.0.6, PHP 5">
	...
	<tag name="dbx_error" type="function" returnType="string" comment="PHP 4 &gt;= 4.0.6, PHP 5">
		<attr name="link_identifier" type="object" status="required"></attr>
	</tag>
	<tag name="dbx_escape_string" type="function" returnType="string" comment="PHP 4 &gt;= 4.3.0, PHP 5">
		<attr name="link_identifier" type="object" status="required"></attr>
		<attr name="text" type="string" status="required"></attr>
	</tag>
	<tag name="dbx_fetch_row" type="function" returnType="object" comment="PHP 5">
		<attr name="result_identifier" type="object" status="required"></attr>
	</tag>
	<tag name="dbx_query" type="function" returnType="object" comment="PHP 4 &gt;= 4.0.6, PHP 5">
		<attr name="link_identifier" type="object" status="required"></attr>
		<attr name="sql_statement" type="string" status="required"></attr>
		<attr name="flags" type="int" status="optional"></attr>
	</tag>
	<tag name="dbx_sort" type="function" returnType="bool" comment="PHP 4 &gt;= 4.0.6, PHP 5">
