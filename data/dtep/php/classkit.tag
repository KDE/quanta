<!DOCTYPE tags>
<tags>
	<tag name="classkit_import" type="function" returnType="array" comment="">
		<attr name="filename" type="string" status="required"></attr>
	</tag>
	<tag name="classkit_method_add" type="function" returnType="bool" comment="">
	...
	<tag name="classkit_method_copy" type="function" returnType="bool" comment="">
	...
	<tag name="classkit_method_redefine" type="function" returnType="bool" comment="">
		<attr name="classname" type="string" status="required"></attr>
		<attr name="methodname" type="string" status="required"></attr>
		<attr name="args" type="string" status="required"></attr>
		<attr name="code" type="string" status="required"></attr>
	...
	<tag name="classkit_method_remove" type="function" returnType="bool" comment="">
		<attr name="classname" type="string" status="required"></attr>
		<attr name="methodname" type="string" status="required"></attr>
	</tag>
	<tag name="classkit_method_rename" type="function" returnType="bool" comment="">
		<attr name="classname" type="string" status="required"></attr>
		<attr name="methodname" type="string" status="required"></attr>
