<!DOCTYPE tags>
<tags>
	<tag name="odbc_autocommit" type="function" returnType="bool">
		<attr name="connection_id" type="resource"></attr>
	...
	<tag name="odbc_columnprivileges" type="function" returnType="int">
		<attr name="connection_id" type="resource"></attr>
		<attr name="qualifier" type="string"></attr>
		<attr name="owner" type="string"></attr>
		<attr name="table_name" type="string"></attr>
		<attr name="column_name" type="string"></attr>
	</tag>
	<tag name="odbc_columns" type="function" returnType="resource">
		<attr name="connection_id" type="resource"></attr>
	...
	<tag name="odbc_connect" type="function" returnType="resource">
		<attr name="dsn" type="string"></attr>
	...
	<tag name="odbc_data_source" type="function" returnType="resource">
		<attr name="connection_id" type="resource"></attr>
		<attr name="fetch_type" type="int"></attr>
	</tag>
	...
	<tag name="odbc_exec" type="function" returnType="resource">
		<attr name="connection_id" type="resource"></attr>
		<attr name="query_string" type="string"></attr>
		<attr name="flags" type="int" status="optional"></attr>
	</tag>
	<tag name="odbc_execute" type="function" returnType="bool">
		<attr name="result_id" type="resource"></attr>
	...
	<tag name="odbc_fetch_into" type="function" returnType="resource">
		<attr name="result_id" type="resource"></attr>
	...
	<tag name="odbc_foreignkeys" type="function" returnType="resource">
		<attr name="connection_id" type="resource"></attr>
		<attr name="pk_qualifier" type="string"></attr>
		<attr name="pk_owner" type="string"></attr>
		<attr name="pk_table" type="string"></attr>
		<attr name="fk_qualifier" type="string"></attr>
		<attr name="fk_owner" type="string"></attr>
		<attr name="fk_table" type="string"></attr>
	</tag>
	...
	<tag name="odbc_pconnect" type="function" returnType="resource">
		<attr name="dsn" type="string"></attr>
		<attr name="user" type="string"></attr>
		<attr name="password" type="string"></attr>
		<attr name="cursor_type" type="int" status="optional"></attr>
	...
	<tag name="odbc_primarykeys" type="function" returnType="resource">
		...
		<attr name="qualifier" type="string"></attr>
		<attr name="owner" type="string"></attr>
		<attr name="table" type="string"></attr>
	</tag>
	...
	<tag name="odbc_setoption" type="function" returnType="int">
		...
		<attr name="function" type="int"></attr>
	...
	<tag name="odbc_specialcolumns" type="function" returnType="resource">
		...
		<attr name="owner" type="string"></attr>
		<attr name="table" type="string"></attr>
		<attr name="scope" type="int"></attr>
		<attr name="nullable" type="int"></attr>
	</tag>
	<tag name="odbc_statistics" type="function" returnType="resource">
		...
		<attr name="owner" type="string"></attr>
		<attr name="table_name" type="string"></attr>
		<attr name="unique" type="int"></attr>
		<attr name="accuracy" type="int"></attr>
	</tag>
