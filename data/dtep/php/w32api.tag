<!DOCTYPE tags>
<tags>
	<tag name="w32api_deftype" type="function" returnType="bool" langVersion="4.2.0 - 4.2.3 only">
	...
	<tag name="w32api_init_dtype" type="function" returnType="resource" langVersion="4.2.0 - 4.2.3 only">
		<attr name="typename" type="string" status="required"></attr>
		<attr name="value" type="mixed" status="required"></attr>
		<attr name="..." type="mixed" status="optional"></attr>
	</tag>
	<tag name="w32api_invoke_function" type="function" returnType="mixed" langVersion="4.2.0 - 4.2.3 only">
		<attr name="funcname" type="string" status="required"></attr>
		<attr name="argument" type="mixed" status="required"></attr>
		<attr name="..." type="mixed" status="optional"></attr>
	</tag>
	<tag name="w32api_register_function" type="function" returnType="bool" langVersion="4.2.0 - 4.2.3 only">
	...
	<tag name="w32api_set_call_method" type="function" returnType="void" langVersion="4.2.0 - 4.2.3 only">
