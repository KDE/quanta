<!DOCTYPE tags>
<tags>
	<tag name="mysql_affected_rows" type="function" returnType="int">
	...
	<tag name="mysql_client_encoding" type="function" returnType="string">
		<attr name="link_identifier" type="resource" status="optional"></attr>
	</tag>
	...
	<tag name="mysql_escape_string" type="function" returnType="string">
		<attr name="unescaped_string" type="string"></attr>
	</tag>
