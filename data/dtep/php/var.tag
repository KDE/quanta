<!DOCTYPE tags>
<tags>
	<tag name="debug_zval_dump" type="function" returnType="void">
		<attr name="variable" type="mixed"></attr>
	</tag>
	<tag name="" type="function" returnType="">
	</tag>
	<tag name="empty" type="function" returnType="bool">
	...
	<tag name="print_r" type="function" returnType="bool">
		<attr name="expression" type="mixed"></attr>
