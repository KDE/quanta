<!DOCTYPE tags>
<tags>
	<tag name="recode_file" type="function" returnType="bool" comment="PHP 3&gt;= 3.0.13, PHP 4 , PHP 5">
	...
	<tag name="recode_string" type="function" returnType="string" comment="PHP 3&gt;= 3.0.13, PHP 4 , PHP 5">
		<attr name="request" type="string" status="required"></attr>
