<!DOCTYPE tags>
<tags>	<tag name="mcrypt_cbc" type="function" returnType="string">
		<attr name="cipher" type="int" status="optional"></attr>
	...
	<tag name="mcrypt_decrypt" type="function" returnType="string">
		<attr name="cipher" type="string" status="optional"></attr>
		<attr name="key" type="string" status="optional"></attr>
		<attr name="data" type="string" status="optional"></attr>
	...
	<tag name="mcrypt_enc_get_algorithms_name" type="function" returnType="string">
		<attr name="td" type="resource" status="optional"></attr>
	</tag>
	...
	<tag name="mcrypt_module_get_algo_block_size" type="function" returnType="int">
		<attr name="algorithm" type="string" status="optional"></attr>
		<attr name="lib_dir" type="string" status="optional"></attr>
	</tag>
	...
	<tag name="mcrypt_module_open" type="function" returnType="resource">
		<attr name="algorithm" type="string" status="optional"></attr>
		<attr name="algorithm_directory" type="string" status="optional"></attr>
		<attr name="mode" type="string" status="optional"></attr>
		<attr name="mode_directory" type="string" status="optional"></attr>
	</tag>
