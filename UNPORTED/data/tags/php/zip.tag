<!DOCTYPE tags>
<tags>	<tag name="zip_close" type="function" returnType="void">
		<attr name="zip" type="resource" status="optional"></attr>
	</tag>
	<tag name="zip_entry_close" type="function" returnType="void">
		<attr name="zip_entry" type="resource" status="optional"></attr>
	</tag>
