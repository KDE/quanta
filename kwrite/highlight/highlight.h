...
class HlPHPLineContinue : public HlItem {
  public:
    HlPHPLineContinue(int attribute, int context);
    virtual bool endEnable(QChar c) {return c == '\0';}
    virtual const QChar *checkHgl(const QChar *);
};

class HlHtmlTagUnknown : public HlItem {
  public:
    HlHtmlTagUnknown(int attribute, int context);
    virtual bool startEnable(QChar c) {return c == '<';}
    virtual const QChar *checkHgl(const QChar *);
};


class HlHtmlAttrib : public HlItem {
  public:
    HlHtmlAttrib(int attribute, int context);
    virtual bool startEnable(QChar c) {return (c != '=') && (c != '<') && (c != '/'); }
    virtual const QChar *checkHgl(const QChar *);
};

class HlHtmlAttribUnknown : public HlItem {
  public:
    HlHtmlAttribUnknown(int attribute, int context);
    virtual bool startEnable(QChar c) {return (c != '=') && (c != '<') && (c != '/'); }
    virtual const QChar *checkHgl(const QChar *);
};

class HlPhpVar : public HlItem {
  public:
    HlPhpVar(int attribute, int context);
    virtual bool startEnable(QChar c) {return c == '$';}
    virtual const QChar *checkHgl(const QChar *);
};

class PhpHighlight : public GenHighlight {
  public:
...
class JSHighlight : public GenHighlight {
  public:
    JSHighlight(const char *name);
    virtual ~JSHighlight();
    virtual QString getCommentStart() { return QString("<!--"); };
    virtual QString getCommentEnd() { return QString("-->"); };
  protected:
...
class SqlHighlight : public GenHighlight {
  public:
    SqlHighlight(const char *name);
    virtual ~SqlHighlight();
    virtual QString getCommentStart() { return QString("#"); };
  protected:
    virtual void createItemData(ItemDataList &);
    virtual void makeContextList();
