...
IDocumentCacheManager * IDocumentCacheManager::instance = 0;
...
{
    return KGlobal::mainComponent().dirs()->saveLocation( "data", KGlobal::mainComponent().componentName()+"/xmlcatalog/cache", true );
}
