...
{ 
    ...
    tabWidget->insertTab( breakpointWidget, tr( "Breakpoints" ) ); 
    ...
    QToolTip::add(buttonApply, "Apply changes to xsldbg after restarting execution"); 
    ...
    QToolTip::add(buttonRefresh, "Refresh values in inspectors from xsldbg"); 
