...
#ifndef XSDDOCUMENTMODEL_H
#define XSDDOCUMENTMODEL_H
...
class XsdDocumentModel : public AbstractXmlModel
{
    Q_OBJECT
public:
  XsdDocumentModel (QObject *parent = 0 );
  ~XsdDocumentModel();
...
private:
    ...
    class DomItem ;
    class DomGroupItem ;
    XsdTreeItem *m_rootItem;
};

#endif //XSDDOCUMENTMODEL_H
